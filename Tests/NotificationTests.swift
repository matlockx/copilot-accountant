...
struct NotificationTests {
    static func main() {
        ...
        test.run("test_Notification_CanBeDisabled") {
            let config = BudgetConfig(monthlyBudget: 300, username: "test", pollingIntervalMinutes: 5, notificationsEnabled: false, alertAt80Percent: false, alertAt90Percent: false, launchAtLogin: false)
        ...
        test.run("test_Notification_Serialization_PreservesSettings") {
            let original = BudgetConfig(monthlyBudget: 300, username: "test", pollingIntervalMinutes: 5, notificationsEnabled: true, alertAt80Percent: false, alertAt90Percent: true, launchAtLogin: false)
